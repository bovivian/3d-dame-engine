...
Input::Input()
{
	...
	inputHandler_leftCursorKeyUp_updated = false;
	...
	keyStateValues[KEYBOARD_KEY_ENTER] = 0x0D;
	keyStateValues[MOUSE_KEY_L] = 40;
	keyStateValues[MOUSE_KEY_R] = 41;
...
void Input::inputHandler_cursorKeyUp_updated()
{
	inputHandler_leftCursorKeyUp_updated = true;
}
